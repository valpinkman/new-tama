...
const langContext = createContext<{
  ...
  lang: null, // eslint-disable-line @typescript-eslint/indent
  changeLang: () => {}, // eslint-disable-line @typescript-eslint/indent
...
export const useTranslations = () => {
  const lang = useLang();
  const [current, setCurrent] = useState<Translations>(
    () => langs[lang || "fr"],
  );
